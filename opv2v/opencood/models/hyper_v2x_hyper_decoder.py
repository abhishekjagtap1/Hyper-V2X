...
from opencood.models.sub_modules.hyper_decoder import HyperDecoder
...
class CorpBEVT(nn.Module):
    def __init__(self, config):
        ...
        Hyper Decoder
        """
        self.decoder = HyperDecoder(decoder_params,
                                    cond_dim=config['seg_head_dim'],  # or fusion output channels
                                    K=4)
